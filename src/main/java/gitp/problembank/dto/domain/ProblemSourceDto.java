...
public class ProblemSourceDto {
    ...
    public ProblemSourceDto(String name, ProblemSourceType sourceType, YearTagDto yearTagDto) {
        this.name = name;
    ...
    public static ProblemSourceDto toDto(ProblemSource entity) {
        return new ProblemSourceDto(
                entity.getName(), entity.getSourceType(), YearTagDto.toDto(entity.getYearTag()));
    }
